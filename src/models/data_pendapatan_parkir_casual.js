...
module.exports = (sequelize, DataTypes) => {
    class data_pendapatan_parkir_casual extends Model {
        /**
        ...
        static associate(models) {
            ...
            data_pendapatan_parkir_casual.belongsTo(models.data_member, {
                foreignKey: 'data_member_id',
                as: 'data_member',
            })
        }
    }
    data_pendapatan_parkir_casual.init(
        {
        ...
        {
            sequelize,
            modelName: 'data_pendapatan_parkir_casual',
        }
    )
    return data_pendapatan_parkir_casual
}
