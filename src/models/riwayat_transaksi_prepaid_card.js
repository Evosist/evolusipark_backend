...
module.exports = (sequelize, DataTypes) => {
    class riwayat_transaksi_prepaid_card extends Model {
        /**
        ...
        static associate(models) {
            ...
            riwayat_transaksi_prepaid_card.belongsTo(models.pos, {
                foreignKey: 'gerbang_masuk_id',
                as: 'gerbang_masuk',
            })

            riwayat_transaksi_prepaid_card.belongsTo(models.kendaraan, {
    ...
    riwayat_transaksi_prepaid_card.init(
        {
        ...
        {
            sequelize,
            modelName: 'riwayat_transaksi_prepaid_card',
        }
    )
    return riwayat_transaksi_prepaid_card
}
